...
- **Isologo stays the abstract concentric-circle placeholder** (mission's own preferred default): no real band isologo asset was supplied before this mission shipped. Proceeding with the placeholder, flagged here as swappable later, per Rule 3 and the mission's own fallback instruction.
